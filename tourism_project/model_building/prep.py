...
df.drop(columns=["CustomerID", "Unnamed: 0"], inplace=True)   # complete the code: drop the customer identifier column, it is not a predictive feature

# Data cleaning: fix a known typo in Gender ("Fe Male" -> "Female")
