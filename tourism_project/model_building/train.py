...
numeric_features = ["Age", "DurationOfPitch", "NumberOfPersonVisiting", "NumberOfFollowups",
                     ...
                     "OwnCar", "NumberOfChildrenVisiting", "MonthlyIncome", "CityTier"]   # complete the code to list all numerical feature names (same as in prep.py)
...
param_grid = {
    ...
    'xgbclassifier__colsample_bytree': [0.7, 0.9],    # Fraction of features sampled when building each tree.
    'xgbclassifier__colsample_bylevel': [0.7, 0.9],   # Fraction of features sampled at each tree level.
